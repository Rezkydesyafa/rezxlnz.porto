...
function AchievementCard({ achievement }: { achievement: any }) {
  return (
    <div className='flex flex-col gap-2 p-2.5 rounded-lg border border-gray-200/50 dark:border-gray-800/50 bg-white/50 dark:bg-[#111]/30 w-full transition-colors hover:border-gray-300 dark:hover:border-gray-700'>
      {/* Image Container */}
      ...
      <div className='flex flex-col gap-1.5 px-0.5'>
        ...
        <div className='flex flex-col gap-0'>
          <h3 className='text-[11px] font-semibold text-gray-900 dark:text-gray-100 leading-snug'>
            {achievement.title}
          </h3>
          <p className='text-[9px] font-serif italic text-gray-500 dark:text-gray-400 leading-relaxed'>
            {achievement.issuer}
          </p>
        </div>

        {/* Tags Row */}
        <div className='flex items-center gap-1.5 mt-0.5 pt-1.5 border-t border-gray-100 dark:border-gray-800/60'>
